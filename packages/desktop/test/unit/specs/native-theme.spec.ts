...
describe('Native theme source', () => {
  ...
  it('uses dark native menus for dark WordBird themes', () => {
  ...
  it('uses the shared WordBird dark theme classification', () => {
  ...
  it('uses light native menus for light WordBird themes', () => {
