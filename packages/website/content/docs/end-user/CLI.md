...
`marktext` should point to your installation of WordBird. The exact location will vary from platform to platform. On macOS, you can create a convenient alias like:
