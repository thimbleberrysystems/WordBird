...
function makeFakeCodeContent(initial: { text: string; lang: string; cursorAt: number }): FakeCell {
  return {
    text: initial.text,
    lang: initial.lang,
...
describe('codeBlockContent.tabHandler — 04834032 Emmet expansion preserves postText', () => {
  it('expands selector and keeps the text after the cursor intact', () => {
    ...
    CodeBlockContent.prototype.tabHandler.call(cell as unknown as CodeBlockContent, makeKeyEvent())
